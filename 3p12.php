...
<head>
    ...
    <script>
        function mult(value) {
            ...
            nbp3 = parseInt(document.getElementById('change1').value) + parseInt(document.getElementById('change2').value) + parseInt(document.getElementById('change3').value) + parseInt(document.getElementById('change4').value)
            ...
            sessionStorage.nbp3 = nbp3;
            sessionStorage.tp = tp;
            sessionStorage.value13 = value;
            document.getElementById('change1').value = sessionStorage.value13;
        ...
        function vult(value) {
            ...
            sessionStorage.nbp3 = nbp3;
            sessionStorage.tp = tp;
            sessionStorage.value23 = value;
            document.getElementById('change2').value = sessionStorage.value23;
            document.getElementById('nbp3').innerHTML = sessionStorage.nbp3;
        }
        function bult(value) {
            var value;
            ...
            sessionStorage.nbp3 = nbp3;
            sessionStorage.tp = tp;
            sessionStorage.value33 = value;
            document.getElementById('change3').value = sessionStorage.value33;
        ...
        function tult(value) {
            ...
            sessionStorage.nbp3 = nbp3;
            sessionStorage.tp = tp;
            sessionStorage.value43 = value;
            document.getElementById('change4').value = sessionStorage.value43;
        ...
        function sult(value) {
            ...
            sessionStorage.nbp3 = nbp3;
            sessionStorage.tp = tp;
            sessionStorage.value53 = value;
            document.getElementById('change5').value = sessionStorage.value53;
            document.getElementById('nbp3').innerHTML = sessionStorage.nbp3;
        }
        function dult(value) {
            var value;
            ...
            sessionStorage.nbp3 = nbp3;
            sessionStorage.tp = tp;
            sessionStorage.x63 = value;
            document.getElementById('change6').value = sessionStorage.x63;
            document.getElementById('nbp3').innerHTML = sessionStorage.nbp3;
        }
        function pult(value) {
            var value;
            ...
            sessionStorage.nbp3 = nbp3;
            sessionStorage.tp = tp;
            sessionStorage.x73 = value;
            document.getElementById('change7').value = sessionStorage.x73;
            document.getElementById('nbp3').innerHTML = sessionStorage.nbp3;
        }
        let count = 6;
        ...
        //     if (text == "") {
        //         alert("Please enter the product03 name");
        //     }
        //     else{
        //         let product03 = document.getElementById('idea').value;
        //         let list = document.getElementById('list');
        //         list.innerHTML += '<li>'+product03+' <input type="number" min="0" max="5" id="change'+count+'" onchange="jult(this.value)"  placeholder=1 /> <button onclick="adreitem'+count+'()"> Change Quantity </button> </li>';
    ...
    <main>
        ...
        <form action="p11.php" method="POST">
            ...
            <ol id="list">
                ...
                <script>
                    if(sessionStorage.product03!=undefined)
                   document.write('<li>' + sessionStorage.product03 +'<input type="number" min="0" max="5" id="change6" onchange="dult(this.value)" /> <button onclick="adreitem6()"> Change Quantity</button></li>')
                </script>
                <script>
                    if(sessionStorage.product23!=undefined)
                   document.write('<li>' + sessionStorage.product23 +'<input type="number" min="0" max="5" id="change7" onchange="pult(this.value)" /> <button onclick="adreitem6()"> Change Quantity</button></li>')
                </script>
