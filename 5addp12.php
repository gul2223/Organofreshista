        ...
        window.onload = function () {
            ...
            if (sessionStorage.value6 !=undefined)
               { document.getElementById('change6').innerHTML = sessionStorage.value6;
                sessionStorage.nbp5 = parseInt(document.getElementById('nbp5').value) + parseInt(document.getElementById('change6').value);
            }
            if (sessionStorage.value7 !=undefined)
                { document.getElementById('chnage7').innerHTML = sessionStorage.value7;
                sessionStorage.nbp5 = parseInt(document.getElementById('nbp5').value) + parseInt(document.getElementById('change7').value);}
            if (sessionStorage.value8 !=undefined)
                {document.getElementById('change8').innerHTML = sessionStorage.value8;
                sessionStorage.nbp5 = parseInt(document.getElementById('nbp5').value) + parseInt(document.getElementById('change8').value);}
            if (sessionStorage.value9 !=undefined)
               { document.getElementById('change9').innerHTML = sessionStorage.value9;
                sessionStorage.nbp5 = parseInt(document.getElementById('nbp5').value) + parseInt(document.getElementById('change9').value);}
            }
            document.getElementById('change5').innerHTML = sessionStorage.value55;
            document.getElementById('change4').innerHTML = sessionStorage.value45;
            document.getElementById('change3').innerHTML = sessionStorage.value35;
            document.getElementById('change2').innerHTML= sessionStorage.value25;
            document.getElementById('change1').innerHTML = sessionStorage.value15;
            
            
            if(sessionStorage.quan!=undefined)
            sessionStorage.nbp5 = parseInt(document.getElementById('change1').value) + parseInt(document.getElementById('change2').value) + parseInt(document.getElementById('change3').value) + parseInt(document.getElementById('change4').value)
            ...
            if(sessionStorage.product05 != undefined)
            {
                ...
                let list1 = '<tr> <td id="product05">'+sessionStorage.product05 + '</td> <td><b id="qauntity" disabled = "disabled">' + sessionStorage.x6+' </b> </td> </tr>'
                list.innerHTML += list1;
            }
            if(sessionStorage.product25 != undefined)
            {
                let list = document.getElementById('list');
                let list1 = '<tr> <td id="product25">'+sessionStorage.product25 + '</td> <td><b id="qauntity2" disabled = "disabled">' + sessionStorage.x75+' </b> </td> </tr>'
                list.innerHTML += list1;
            }
        }
        function productadd(){
        <?php if(isset($_POST['product05'] )) {
            print 'let product05 = "'. $_POST["product05"] .'";
            let quan = "'. $_POST["quantity"] .'";
                var x;
                var tp;
                tp = sessionStorage.nbp5;
                x = quan;
                tp = parseInt(tp) + parseInt(x);
                sessionStorage.nbp5 = parseInt(tp); 
                sessionStorage.x6 = parseInt(x);
                sessionStorage.product05 = product05;';
                $_SESSION["product05"] = print 'sessionStorage.product05';
                $_SESSION["x6"] = print 'x6';
        }?>
        <?php if(isset($_POST['product25'] )) {
            print '
            let product25 ="'. $_POST["product25"] .'";
            let quan2 = "'. $_POST["quantity2"] .'";
                ...
                tp = parseInt(tp) + parseInt(x);
                sessionStorage.nbp5 = parseInt(tp); 
                sessionStorage.x75 = parseInt(x);
                sessionStorage.product25 = product25;';
        }?>}
        function adreitem4() {
...
<body>
    ...
    <main>
        ...
        <form action="5addp12.php" method="POST">
            ...
            <table id="list" border=1 cellpadding="2">
                ...
                <script> if(sessionStorage.product05 == undefined){
                <?php 
                 if(isset($_POST['product05'] )) {
                    if(isset($_POST['quantity'] ))
                   print ' <tr> <td id="product05">'.$_POST['product05'].'</td> <td><b id="qauntity" disabled = "disabled">'.$_POST['quantity'].' </b> </td> </tr>';
                   else {
                ...
                <?php if(isset($_POST['product25'] )) {
                   ...
                   print ' <tr> <td id="product25">'.$_POST['product25'].'</td> <td><b id="qauntity2" disabled = "disabled">'.$_POST['quantity2'].' </b> </td> </tr>';
                   else {
                       print 'alert("Please enter the quantity")';
                   }
                }
                ...
                <ol> <li> <input type="text"  name= "product05" placeholder="Product name" /> <input type="number" min=0 max=5 id = "quan" size="3" name= "quantity"/></li>
                <li><input type="text"  name= "product25" placeholder="Product name" /> <input type="number" min=0 max=5 id = "quan" size="3"  name= "quantity2"/></li><ol>
