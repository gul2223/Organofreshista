...
<head>
    ...
    <script>
        function mult(value) {
            ...
            nbp4 = parseInt(document.getElementById('change1').value) + parseInt(document.getElementById('change2').value) + parseInt(document.getElementById('change3').value) + parseInt(document.getElementById('change4').value)
            ...
            sessionStorage.nbp4 = nbp4;
            sessionStorage.tp = tp;
            sessionStorage.value14 = value;
            document.getElementById('change1').value = sessionStorage.value14;
        ...
        function vult(value) {
            ...
            sessionStorage.nbp4 = nbp4;
            sessionStorage.tp = tp;
            sessionStorage.value24 = value;
            document.getElementById('change2').value = sessionStorage.value24;
            document.getElementById('nbp4').innerHTML = sessionStorage.nbp4;
        }
        function bult(value) {
            var value;
            ...
            sessionStorage.nbp4 = nbp4;
            sessionStorage.tp = tp;
            sessionStorage.value34 = value;
            document.getElementById('change3').value = sessionStorage.value34;
        ...
        function tult(value) {
            ...
            sessionStorage.nbp4 = nbp4;
            sessionStorage.tp = tp;
            sessionStorage.value44 = value;
            document.getElementById('change4').value = sessionStorage.value44;
        ...
        function sult(value) {
            ...
            sessionStorage.nbp4 = nbp4;
            sessionStorage.tp = tp;
            sessionStorage.value54 = value;
            document.getElementById('change5').value = sessionStorage.value54;
            document.getElementById('nbp4').innerHTML = sessionStorage.nbp4;
        }
        function dult(value) {
            var value;
            ...
            sessionStorage.nbp4 = nbp4;
            sessionStorage.tp = tp;
            sessionStorage.x64 = value;
            document.getElementById('change6').value = sessionStorage.x64;
            document.getElementById('nbp4').innerHTML = sessionStorage.nbp4;
        }
        function pult(value) {
            var value;
            ...
            sessionStorage.nbp4 = nbp4;
            sessionStorage.tp = tp;
            sessionStorage.x74 = value;
            document.getElementById('change7').value = sessionStorage.x74;
            document.getElementById('nbp4').innerHTML = sessionStorage.nbp4;
        }
        let count = 6;
        ...
        //     if (text == "") {
        //         alert("Please enter the product04 name");
        //     }
        //     else{
        //         let product04 = document.getElementById('idea').value;
        //         let list = document.getElementById('list');
        //         list.innerHTML += '<li>'+product04+' <input type="number" min="0" max="5" id="change'+count+'" onchange="jult(this.value)"  placeholder=1 /> <button onclick="adreitem'+count+'()"> Change Quantity </button> </li>';
    ...
    <main>
        ...
        <form action="p11.php" method="POST">
            ...
            <ol id="list">
                ...
                <script>
                    if(sessionStorage.product04!=undefined)
                   document.write('<li>' + sessionStorage.product04 +'<input type="number" min="0" max="5" id="change6" onchange="dult(this.value)" /> <button onclick="adreitem6()"> Change Quantity</button></li>')
                </script>
                <script>
                    if(sessionStorage.product24!=undefined)
                   document.write('<li>' + sessionStorage.product24 +'<input type="number" min="0" max="5" id="change7" onchange="pult(this.value)" /> <button onclick="adreitem6()"> Change Quantity</button></li>')
                </script>
