        ...
        window.onload = function () {
            ...
            if (sessionStorage.value6 !=undefined)
               { document.getElementById('change6').innerHTML = sessionStorage.value6;
                sessionStorage.nbp6 = parseInt(document.getElementById('nbp6').value) + parseInt(document.getElementById('change6').value);
            }
            if (sessionStorage.value7 !=undefined)
                { document.getElementById('chnage7').innerHTML = sessionStorage.value7;
                sessionStorage.nbp6 = parseInt(document.getElementById('nbp6').value) + parseInt(document.getElementById('change7').value);}
            if (sessionStorage.value8 !=undefined)
                {document.getElementById('change8').innerHTML = sessionStorage.value8;
                sessionStorage.nbp6 = parseInt(document.getElementById('nbp6').value) + parseInt(document.getElementById('change8').value);}
            if (sessionStorage.value9 !=undefined)
               { document.getElementById('change9').innerHTML = sessionStorage.value9;
                sessionStorage.nbp6 = parseInt(document.getElementById('nbp6').value) + parseInt(document.getElementById('change9').value);}
            }
            document.getElementById('change5').innerHTML = sessionStorage.value56;
            document.getElementById('change4').innerHTML = sessionStorage.value46;
            document.getElementById('change3').innerHTML = sessionStorage.value36;
            document.getElementById('change2').innerHTML= sessionStorage.value26;
            document.getElementById('change1').innerHTML = sessionStorage.value16;
            
            
            if(sessionStorage.quan!=undefined)
            sessionStorage.nbp6 = parseInt(document.getElementById('change1').value) + parseInt(document.getElementById('change2').value) + parseInt(document.getElementById('change3').value) + parseInt(document.getElementById('change4').value)
            ...
            if(sessionStorage.product06 != undefined)
            {
                ...
                let list1 = '<tr> <td id="product06">'+sessionStorage.product06 + '</td> <td><b id="qauntity" disabled = "disabled">' + sessionStorage.x66+' </b> </td> </tr>'
                list.innerHTML += list1;
            }
            if(sessionStorage.product26 != undefined)
            {
                let list = document.getElementById('list');
                let list1 = '<tr> <td id="product26">'+sessionStorage.product26 + '</td> <td><b id="qauntity2" disabled = "disabled">' + sessionStorage.x76+' </b> </td> </tr>'
                list.innerHTML += list1;
            }
        }
        function productadd(){
        <?php if(isset($_POST['product06'] )) {
            print 'let product06 = "'. $_POST["product06"] .'";
            let quan = "'. $_POST["quantity"] .'";
                var x;
                var tp;
                tp = sessionStorage.nbp6;
                x = quan;
                tp = parseInt(tp) + parseInt(x);
                sessionStorage.nbp6 = parseInt(tp); 
                sessionStorage.x66 = parseInt(x);
                sessionStorage.product06 = product06;';
                $_SESSION["product06"] = print 'sessionStorage.product06';
                $_SESSION["x66"] = print 'x66';
        }?>
        <?php if(isset($_POST['product26'] )) {
            print '
            let product26 ="'. $_POST["product26"] .'";
            let quan2 = "'. $_POST["quantity2"] .'";
                ...
                tp = parseInt(tp) + parseInt(x);
                sessionStorage.nbp6 = parseInt(tp); 
                sessionStorage.x76 = parseInt(x);
                sessionStorage.product26 = product26;';
        }?>}
        function adreitem4() {
...
<body>
    ...
    <main>
        ...
        <form action="6addp12.php" method="POST">
            ...
            <table id="list" border=1 cellpadding="2">
                ...
                <script> if(sessionStorage.product06 == undefined){
                <?php 
                 if(isset($_POST['product06'] )) {
                    if(isset($_POST['quantity'] ))
                   print ' <tr> <td id="product06">'.$_POST['product06'].'</td> <td><b id="qauntity" disabled = "disabled">'.$_POST['quantity'].' </b> </td> </tr>';
                   else {
                ...
                <?php if(isset($_POST['product26'] )) {
                   ...
                   print ' <tr> <td id="product26">'.$_POST['product26'].'</td> <td><b id="qauntity2" disabled = "disabled">'.$_POST['quantity2'].' </b> </td> </tr>';
                   else {
                       print 'alert("Please enter the quantity")';
                   }
                }
           ...
           <ol> <li> <input type="text"  name= "product06" placeholder="Product name" /> <input type="number" min=0 max=5 id = "quan" size="3" name= "quantity"/> </li>
           <li><input type="text"  name= "product26" placeholder="Product name" /> <input type="number" min=0 max=5 id = "quan" size="3"  name= "quantity2"/></li></ol>
